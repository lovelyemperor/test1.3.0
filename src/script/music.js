(function($){
	...
	*/
	...
	$.fn.simplemusic=function(settings){
		$(this).css({"z-index":"999","width":"44px","height":"44px","position":"fixed","bottom":"10px","left":"10px","cursor":"pointer","background":"url(https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/music.png)"}).bind("click",function(){
			if(_playstatus){
				pause(this);
			}else{
				play(this);
