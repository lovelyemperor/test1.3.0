...
//----------------------------------- 初始化 -----------------------------------------//
     ...
     */
    this.init = function () {
        lovelyemperorJs.loadingBeforeInit(); // Loading 前初始化
        lovelyemperorJs.endLoading();        // Loading 结束
        lovelyemperorJs.loadingAfterInit();  // Loading 后初始化
    };
...
//----------------------------- Loading 前后逻辑处理 ----------------------------------//
    ...
    this.loadingBeforeInit = function () {
        ...
        // 延时清除全部定时器
        setTimeout(lovelyemperorJs.clearIntervalAll, 30000);

        // 添加扩展字体图标库
        if (window.cnblogsConfig.fontIconExtend !== '') tools.dynamicLoadingCss(window.cnblogsConfig.fontIconExtend);

        // 页面初始化
        isHome ? lovelyemperorJs.notHomeInit() : lovelyemperorJs.homeInit();
    };
    ...
    this.loadingAfterInit = function () {
        ...
        // 页面初始化
        isHome ? lovelyemperorJs.notHomeInitAfter() : lovelyemperorJs.homeInitAfter();

        // 添加页脚
        lovelyemperorJs.addFooter();
        ...
        // 滚动监听
        $(window).scroll( function() { lovelyemperorJs.scrollMonitor(); });

        // 窗口变化监听
        $(window).resize( function() { lovelyemperorJs.resizeMonitor(); });
        ...
        // 设置菜单个人简介头像
        let blogAvatar = window.cnblogsConfig.blogAvatar ? window.cnblogsConfig.blogAvatar : 'https://cdn.jsdelivr.net/gh/lovelyemperor/Cnblogs-Theme-SimpleMemory@master/img/webp/default_avatar.webp';
        $('#menuBlogAvatar').append("<img src='"+blogAvatar+"'>");

        // html5-title
        lovelyemperorJs.htmlTitle();

        // 设置菜单个人信息背景图片
        lovelyemperorJs.setMenuUserInfoImg();

        // 设置菜单侧边栏内容
        let setMenuData = lovelyemperorJs.setMenuData();
        ...
        // 添加页面特效控制
        // lovelyemperorJs.setPageAnimationControl();

        // 添加日/夜间模式控制
        window.cnblogsConfig.switchDayNight.enable && lovelyemperorJs.setDayNightControl();
...
//=================== 逻辑处理：公共方法
    ...
    this.resizeMonitor = function() {
        ...
        lovelyemperorJs.setDomHomePosition();
    ...
    this.setMenuData = function() {
        ...
        function setIntroduce() {
            if ((typeof introduceHtml == 'string') && menuIntroduce.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuIntroduceTId);
            }
        }
        ...
        function setCalendar() {
            if (calendarTable.length > 0 && menuCalendar.html() === ''){
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuCalendarTId);
            }
        }
        ...
        function setSidebarSearch() {
            if (sidebarSearch.length > 0 && menuSearchBox.html() === ''){
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setSidebarSearchTId);
            }
        }
        ...
        function setSidebarScorerank() {
            if (scorerank.length > 0 && menuScorerank.html() === ''){
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setSidebarScorerankTId);
            }
        }
        ...
        function setSidebar() {
            if (sidebar.length > 0 && menuSidebar.html() === ''){
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuSidebarTId);
            }
        }
        ...
        function setToptags() {
            if (toptags.length > 0 && menuToptags.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuToptagsTId);
            }
        }
        ...
        function setClassify() {
            if (sbClassify.length > 0 && menuClassify.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuClassifyTId);
            }
        }
        ...
        function setArticleCategory() {
            if (sbArticleCategory.length > 0 && menuArticleCategory.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuArticleCategoryTId);
            }
        }
        ...
        function setRecord() {
            if (sbRecord.length > 0 && menuRecord.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuRecordTId);
            }
        }
        ...
        function setArticle() {
            if (sbArticle.length > 0 && menuArticle.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuArticleTId);
            }
        }
        ...
        function setTopview() {
            if (sbTopview.length > 0 && menuTopview.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuTopviewTId);
            }
        }
        ...
        function setTopDiggPosts() {
            if (topDiggPosts.length > 0 && menuTopDiggPosts.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuTopDiggPostsTId);
            }
        }
        ...
        function setRecentComments() {
            if (recentComments.length > 0 && menuRecentComments.html() === '') {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setMenuRecentCommentsTId);
            }
        }
    ...
    this.addFooter = function() {
        ...
        function setCnzz() {
            ...
            if (cnzzStat.length > 0) {
                ...
                lovelyemperorJs.clearIntervalTimeId(timeIds.setCnzzTId);
            }
        }
...
//=================== 逻辑处理：主页处理
    ...
    this.homeInit = function() {
        ...
        lovelyemperorJs.setHitokoto();
        lovelyemperorJs.scrollMonitor();
        lovelyemperorJs.setDomHomePosition();
    };

    this.homeInitAfter = function () {
        lovelyemperorJs.setHomePost();
        lovelyemperorJs.setEntryPost();
        ...
        // 设置右下角菜单
        timeIds.setHomeRightMenuTId = window.setInterval( lovelyemperorJs.addHomeRightMenu, 1000 );
    ...
    this.addHomeRightMenu = function() {
        ...
        if (rightMenu.length > 0) {
            ...
            lovelyemperorJs.rightMenuMous('#toUpDown', '.toUpDownSpan');
            ...
            lovelyemperorJs.rightMenuMous('#attention', '.attentionSpan');
            lovelyemperorJs.scrollMonitor(); // 触发一次滚动处理，防止未有对象，初始化失败
            lovelyemperorJs.clearIntervalTimeId(timeIds.setHomeRightMenuTId);
        }
    };
...
//=================== 逻辑处理：非主页处理
    ...
    this.notHomeInit = function() {
        ...
        // 设置文章信息
        lovelyemperorJs.setArticleInfoAuthor();
        timeIds.blogPostCategoryTId = window.setInterval( lovelyemperorJs.setArticleInfoClass, 1000 );
        timeIds.entryTagTId         = window.setInterval( lovelyemperorJs.setArticleInfoTag, 1000 );

        lovelyemperorJs.setDomHomePosition();
    };

    this.notHomeInitAfter = function () {
        lovelyemperorJs.setNotHomeTopImg();

        // 验证是否是书单文章
        if ($('#bookListFlg').length > 0) lovelyemperorJs.setBookList();

        lovelyemperorJs.setCodeHighlighting();
        lovelyemperorJs.baguetteBox();

        // 初始化文章目录
        require(['title', 'marvin', 'articleStatement'], function() {
            timeIds.setCatalogTId = window.setInterval( lovelyemperorJs.initCatalog, 1000 );
            lovelyemperorJs.scrollMonitor();
        ...
        // 设置右下角菜单
        timeIds.setNotHomeRightMenuTId = window.setInterval( lovelyemperorJs.addNotHomeRightMenu, 1000 );

        lovelyemperorJs.setCommentStyle();
    };
    ...
    this.setArticleInfoClass = function () {
        ...
        if (obj.length > 0) {
            ...
            lovelyemperorJs.clearIntervalTimeId(timeIds.blogPostCategoryTId);
        }
    };
    ...
    this.setArticleInfoTag = function () {
        ...
        if (obj.length > 0) {
            ...
            lovelyemperorJs.clearIntervalTimeId(timeIds.entryTagTId);
        }
    };
    ...
    this.initCatalog = function() {
        ...
        if (sideToolbar.length > 0) {
            ...
            lovelyemperorJs.resizeMonitor();
            lovelyemperorJs.clearIntervalTimeId(timeIds.setCatalogTId);
        }
    };
        ...
        function setScrollbarStyle() {
            ...
            let scrollbarTimeId = window.setInterval( function () {
                if ($('.post pre span').length > 0) {
                    ...
                    lovelyemperorJs.clearIntervalTimeId(scrollbarTimeId);
                }
            }, 500 );
        }
    };
    ...
    this.setCommentStyle = function() {
        timeIds.commentTId = window.setInterval(function(){
            if ($('.feedbackItem').length > 0) {
                setComment();
                lovelyemperorJs.clearIntervalTimeId(timeIds.commentTId);
            }
        },1000);
                ...
                $.each(feedbackItem, function (i) {
                    ...
                    if (idInfo && idInfo.length > 0) {
                        ...
                        let op = $('#comment_' + id + '_avatar'), patch  = op.length > 0 ? $.trim(op.text())
                            : 'https://cdn.jsdelivr.net/gh/lovelyemperor/Cnblogs-Theme-SimpleMemory@master/img/webp/default_avatar.webp';
    ...
    this.addNotHomeRightMenu = function() {
        ...
        if (rightMenu.length > 0 && $('#div_digg').length > 0) {
            ...
            if ($('#toUpDown').length === 0 && $('#attention').length === 0) lovelyemperorJs.addHomeRightMenu();
            ...
            lovelyemperorJs.rightMenuMous('#rightBuryit', '.rightBuryitSpan');
            ...
            lovelyemperorJs.rightMenuMous('#rightDiggit', '.rightDiggitSpan');
            ...
            if (window.cnblogsConfig.reward.enable && (window.cnblogsConfig.reward.alipay || window.cnblogsConfig.reward.wechatpay)) {
                ...
                lovelyemperorJs.rightMenuMous('#rightDashang', '.rightDanshanSpan');
            }

            lovelyemperorJs.clearIntervalTimeId(timeIds.setNotHomeRightMenuTId);
        }
    }
}